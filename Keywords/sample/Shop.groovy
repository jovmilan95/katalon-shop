...
public class Shop {
	...
	def static void addToCart(String productName,String urlProduct){
		...
		WebUI.waitForElementPresent(findTestObject('Pages/Shop/btnAddToCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('Pages/Shop/btnAddToCart'))
		...
		WebUI.verifyElementPresent(findTestObject('Pages/Shop/btnProceed'), GlobalVariable.waitPresentTimeout)
	}
	...
	def static void applyCouponAndAddToCart(String productName,String urlProduct,String coupon){
		...
		WebUI.setText(findTestObject('Pages/Shop/txtCoupon'), coupon)
		WebUI.click(findTestObject('Pages/Shop/btnApply'))
	}
